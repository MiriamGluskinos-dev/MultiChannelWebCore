import { useState as pe, useEffect as Ot } from "react";
import { jsx as T, jsxs as Y } from "react/jsx-runtime";
import { Button as We, Icon as Ge, Toast as Yt } from "@igds/react";
...
const { toString: tn } = Object.prototype, { getPrototypeOf: Me } = Object, { iterator: Ee, toStringTag: Et } = Symbol, Ce = /* @__PURE__ */ ((n) => (e) => {
  const t = tn.call(e);
  return n[t] || (n[t] = t.slice(8, -1).toLowerCase());
})(/* @__PURE__ */ Object.create(null)), U = (n) => (n = n.toLowerCase(), (e) => Ce(e) === n), Le = (n) => (e) => typeof e === n, { isArray: Z } = Array, Q = Le("undefined");
function oe(n) {
  return n !== null && !Q(n) && n.constructor !== null && !Q(n.constructor) && k(n.constructor.isBuffer) && n.constructor.isBuffer(n);
}
...
const sn = Le("string"), k = Le("function"), Lt = Le("number"), ae = (n) => n !== null && typeof n == "object", rn = (n) => n === !0 || n === !1, ge = (n) => {
  if (Ce(n) !== "object")
    return !1;
  const e = Me(n);
  return (e === null || e === Object.prototype || Object.getPrototypeOf(e) === null) && !(Et in n) && !(Ee in n);
}, on = (n) => {
  if (!ae(n) || oe(n))
    return !1;
  try {
...
}, an = U("Date"), ln = U("File"), un = U("Blob"), cn = U("FileList"), fn = (n) => ae(n) && k(n.pipe), dn = (n) => {
  let e;
...
}, hn = U("URLSearchParams"), [pn, gn, mn, yn] = ["ReadableStream", "Request", "Response", "Headers"].map(U), bn = (n) => n.trim ? n.trim() : n.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
function le(n, e, { allOwnKeys: t = !1 } = {}) {
  if (n === null || typeof n > "u")
    return;
  let s, r;
  if (typeof n != "object" && (n = [n]), Z(n))
...
const K = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : global, Tt = (n) => !Q(n) && n !== K;
function De() {
  const { caseless: n, skipUndefined: e } = Tt(this) && this || {}, t = {}, s = (r, i) => {
    const o = n && Nt(t, i) || i;
    ge(t[o]) && ge(r) ? t[o] = De(t[o], r) : ge(r) ? t[o] = De({}, r) : Z(r) ? t[o] = r.slice() : (!e || !Q(r)) && (t[o] = r);
  };
...
const Sn = (n, e, t, { allOwnKeys: s } = {}) => (le(e, (r, i) => {
  ...
  for (; (t = n.exec(e)) !== null; )
    s.push(t);
  return s;
}, Tn = U("HTMLFormElement"), Pn = (n) => n.toLowerCase().replace(
  /[-_\s]([a-z\d])(\w*)/g,
  function(t, s, r) {
    return s.toUpperCase() + r;
  }
), Xe = (({ hasOwnProperty: n }) => (e, t) => n.call(e, t))(Object.prototype), An = U("RegExp"), Pt = (n, e) => {
  ...
  return Z(n) ? s(n) : s(String(n).split(e)), t;
}, Fn = () => {
}, $n = (n, e) => n != null && Number.isFinite(n = +n) ? n : e;
function jn(n) {
  return !!(n && k(n.append) && n[Et] === "FormData" && n[Ee]);
}
const Un = (n) => {
  ...
  return t(n, 0);
}, Dn = U("AsyncFunction"), In = (n) => n && (ae(n) || k(n)) && k(n.then) && k(n.catch), At = ((n, e) => n ? setImmediate : e ? ((t, s) => (K.addEventListener("message", ({ source: r, data: i }) => {
  r === K && i === t && s.length && s.shift()();
}, !1), (r) => {
  s.push(r), K.postMessage(t, "*");
}))(`axios@${Math.random()}`, []) : (t) => setTimeout(t))(
  typeof setImmediate == "function",
  k(K.postMessage)
), Bn = typeof queueMicrotask < "u" ? queueMicrotask.bind(K) : typeof process < "u" && process.nextTick || At, _n = (n) => n != null && k(n[Ee]), f = {
  isArray: Z,
  isArrayBuffer: Ct,
  isBuffer: oe,
  isFormData: dn,
...
function Ye(n, e, t) {
  return n ? n.concat(e).map(function(r, i) {
    return r = Ft(r), !t && i ? "[" + r + "]" : r;
  }).join(t ? "." : "") : e;
}
function Mn(n) {
  return f.isArray(n) && !n.some(Ie);
}
...
function Ne(n, e, t) {
  ...
  function c(d, m, g) {
    ...
    if (d && !g && typeof d == "object") {
      ...
      else if (f.isArray(d) && Mn(d) || (f.isFileList(d) || f.endsWith(m, "[]")) && (w = f.toArray(d)))
        return m = Ft(m), w.forEach(function(E, S) {
          !(f.isUndefined(E) || E === null) && e.append(
            // eslint-disable-next-line no-nested-ternary
            o === !0 ? Ye([m], S, i) : o === null ? m : m + "[]",
            u(E)
          );
        }), !1;
    }
    return Ie(d) ? !0 : (e.append(Ye(g, m, i), u(d)), !1);
  }
  const p = [], h = Object.assign(Vn, {
    defaultVisitor: c,
    convertValue: u,
    isVisitable: Ie
  });
  function y(d, m) {
    if (!f.isUndefined(d)) {
      ...
      p.push(d), f.forEach(d, function(w, x) {
...
}, qn = typeof URLSearchParams < "u" ? URLSearchParams : Ve, zn = typeof FormData < "u" ? FormData : null, Jn = typeof Blob < "u" ? Blob : null, Wn = {
  isBrowser: !0,
  classes: {
    URLSearchParams: qn,
    FormData: zn,
...
}, Ke = typeof window < "u" && typeof document < "u", Be = typeof navigator == "object" && navigator || void 0, Gn = Ke && (!Be || ["ReactNative", "NativeScript", "NS"].indexOf(Be.product) < 0), Xn = typeof WorkerGlobalScope < "u" && // eslint-disable-next-line no-undef
self instanceof WorkerGlobalScope && typeof self.importScripts == "function", Yn = Ke && window.location.href || "http://localhost", Qn = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  hasBrowserEnv: Ke,
...
let F = class {
  ...
  delete(e, t) {
    ...
    function i(o) {
      if (o = se(o), o) {
        ...
        a && (!t || ve(s, s[a], a, t)) && (delete s[a], r = !0);
      }
    }
  ...
  clear(e) {
    ...
    for (; s--; ) {
      const i = t[s];
      (!e || ve(this, this[i], i, e, !0)) && (delete this[i], r = !0);
    }
    return r;
  }
  normalize(e) {
...
const be = (n, e, t = 3) => {
...
}, nt = (n) => (...e) => f.asap(() => n(...e)), ds = A.hasStandardBrowserEnv ? /* @__PURE__ */ ((n, e) => (t) => (t = new URL(t, A.origin), n.protocol === t.protocol && n.host === t.host && (e || n.port === t.port)))(
  new URL(A.origin),
  ...
  // Standard browser envs support document.cookie
  {
    write(n, e, t, s, r, i) {
      ...
      f.isNumber(t) && o.push("expires=" + new Date(t).toGMTString()), f.isString(s) && o.push("path=" + s), f.isString(r) && o.push("domain=" + r), i === !0 && o.push("secure"), document.cookie = o.join("; ");
    },
    read(n) {
...
function z(n, e) {
  ...
  function r(u, c, p, h) {
    if (f.isUndefined(c)) {
      if (!f.isUndefined(u))
        return s(void 0, u, p, h);
    } else return s(u, c, p, h);
  }
  function i(u, c) {
    if (!f.isUndefined(c))
      return s(void 0, c);
  ...
  const l = {
    ...
    responseEncoding: o,
    validateStatus: a,
    headers: (u, c, p) => r(st(u), st(c), p, !0)
  };
  return f.forEach(Object.keys({ ...n, ...e }), function(c) {
    const p = l[c] || r, h = p(n[c], e[c], c);
    f.isUndefined(h) && p !== a || (t[c] = h);
  }), t;
}
const Ht = (n) => {
  const e = z({}, n);
  let { data: t, withXSRFToken: s, xsrfHeaderName: r, xsrfCookieName: i, headers: o, auth: a } = e;
  if (e.headers = o = F.from(o), e.url = jt(_t(e.baseURL, e.url, e.allowAbsoluteUrls), n.params, n.paramsSerializer), a && o.set(
    "Authorization",
  ...
  return new Promise(function(t, s) {
    ...
    let { responseType: a, onUploadProgress: l, onDownloadProgress: u } = r, c, p, h, y, d;
    function m() {
    ...
    "onloadend" in g ? g.onloadend = w : g.onreadystatechange = function() {
      ...
      g && (s(new b("Request aborted", b.ECONNABORTED, n, g)), g = null);
    }, g.onerror = function(S) {
      const R = S && S.message ? S.message : "Network Error", N = new b(R, b.ERR_NETWORK, n, g);
      N.event = S || null, s(N), g = null;
    }, g.ontimeout = function() {
      let S = r.timeout ? "timeout of " + r.timeout + "ms exceeded" : "timeout exceeded";
      const R = r.transitional || Ut;
    ...
    }, i === void 0 && o.setContentType(null), "setRequestHeader" in g && f.forEach(o.toJSON(), function(S, R) {
      g.setRequestHeader(R, S);
    }), f.isUndefined(r.withCredentials) || (g.withCredentials = !!r.withCredentials), a && a !== "json" && (g.responseType = r.responseType), u && ([h, d] = be(u, !0), g.addEventListener("progress", h)), l && g.upload && ([p, y] = be(l), g.upload.addEventListener("progress", p), g.upload.addEventListener("loadend", y)), (r.cancelToken || r.signal) && (c = (E) => {
      g && (s(!E || E.type ? new ee(null, n, g) : E), g.abort(), g = null);
  ...
  if (e || t) {
    ...
    const i = function(u) {
      if (!r) {
        ...
        s.abort(c instanceof b ? c : new ee(c instanceof Error ? c.message : c));
      }
    };
    let o = e && setTimeout(() => {
...
}, it = 64 * 1024, { isFunction: de } = f, Mt = (({ fetch: n, Request: e, Response: t }) => ({
  fetch: n,
  Request: e,
  Response: t
}))(f.global), {
  ...
  const { fetch: e, Request: t, Response: s } = Object.assign({}, Mt, n), r = de(e), i = de(t), o = de(s);
  if (!r)
    return !1;
  const a = r && de(ot), l = r && (typeof at == "function" ? /* @__PURE__ */ ((d) => (m) => d.encode(m))(new at()) : async (d) => new Uint8Array(await new t(d).arrayBuffer())), u = i && a && lt(() => {
    let d = !1;
    const m = new t(A.origin, {
      body: new ot(),
      method: "POST",
      get duplex() {
        return d = !0, "half";
    ...
    return d && !m;
  }), c = o && a && lt(() => f.isReadableStream(new s("").body)), p = {
    stream: c && ((d) => d.body)
  };
  r && ["text", "arrayBuffer", "blob", "formData", "stream"].forEach((d) => {
    !p[d] && (p[d] = (m, g) => {
      ...
      if (w)
        return w.call(m);
      throw new b(`Response type '${d}' is not supported`, b.ERR_NOT_SUPPORT, g);
    });
  });
  const h = async (d) => {
    if (d == null)
  ...
  return async (d) => {
    ...
    let te = bs([x, E && E.toAbortSignal()], S), V = null;
    const $ = te && te.unsubscribe && (() => {
      te.unsubscribe();
    });
    let M;
    try {
      if (N && u && g !== "get" && g !== "head" && (M = await y(_, w)) !== 0) {
        let j = new t(m, {
          method: "POST",
          body: w,
          duplex: "half"
        }), W;
        if (f.isFormData(w) && (W = j.headers.get("content-type")) && _.setContentType(W), j.body) {
          const [Ae, fe] = tt(
            M,
            be(nt(N))
          );
          w = rt(j.body, it, Ae, fe);
        }
      }
      f.isString(J) || (J = J ? "include" : "omit");
      const v = i && "credentials" in t.prototype, ne = {
        ...H,
        signal: te,
      ...
      V = i && new t(m, ne);
      let C = await (i ? e(V, H) : e(m, ne));
      const B = c && (O === "stream" || O === "response");
      if (c && (R || B && $)) {
        const j = {};
        ["status", "statusText", "headers"].forEach((Je) => {
          j[Je] = C[Je];
        });
        const W = f.toFiniteNumber(C.headers.get("content-length")), [Ae, fe] = R && tt(
          W,
          be(nt(R), !0)
        ) || [];
        C = new s(
      ...
      O = O || "text";
      let ce = await p[f.findKey(p, O) || "text"](C, d);
      return !B && $ && $(), await new Promise((j, W) => {
        Bt(j, W, {
          data: ce,
      ...
      throw $ && $(), v && v.name === "TypeError" && /Load failed|fetch/i.test(v.message) ? Object.assign(
        new b("Network Error", b.ERR_NETWORK, d, V),
        {
          cause: v.cause || v
        }
      ) : b.from(v, v && v.code, d, V);
    }
  };
}, Rs = /* @__PURE__ */ new Map(), Vt = (n) => {
  let e = f.merge.call({
    skipUndefined: !0
  }, Mt, n ? n.env : null);
  ...
  let o = i.length, a = o, l, u, c = Rs;
  for (; a--; )
    l = i[a], u = c.get(l), u === void 0 && c.set(l, u = a ? /* @__PURE__ */ new Map() : Os(e)), c = u;
  return u;
};
Vt();
const _e = {
...
const ut = (n) => `- ${n}`, Es = (n) => f.isFunction(n) || n === null || n === !1, Kt = {
  getAdapter: (n, e) => {
    n = f.isArray(n) ? n : [n];
    const { length: t } = n;
    let s, r;
    ...
    for (let o = 0; o < t; o++) {
      s = n[o];
      let a;
      if (r = s, !Es(s) && (r = _e[(a = String(s)).toLowerCase()], r === void 0))
...
function ct(n) {
  return Fe(n), n.headers = F.from(n.headers), n.data = ke.call(
    n,
    n.transformRequest
  ), ["post", "put", "patch"].indexOf(n.method) !== -1 && n.headers.setContentType("application/x-www-form-urlencoded", !1), Kt.getAdapter(n.adapter || ue.adapter, n)(n).then(function(s) {
    return Fe(n), s.data = ke.call(
      n,
      n.transformResponse,
      s
    ), s.headers = F.from(s.headers), s;
  }, function(s) {
    return It(s) || (Fe(n), s && s.response && (s.response.data = ke.call(
      n,
      n.transformResponse,
      s.response
...
Te.transitional = function(e, t, s) {
  ...
  return (i, o, a) => {
    ...
    return t && !ft[o] && (ft[o] = !0, console.warn(
      r(
        o,
...
` + i) : s.stack = i;
  ...
  _request(e, t) {
    ...
    if (!l) {
      ...
      for (d.unshift(...a), d.push(...u), h = d.length, c = Promise.resolve(t); p < h; )
        c = c.then(d[p++], d[p++]);
      return c;
    }
    h = a.length;
  ...
  getUri(e) {
    e = z(this.defaults, e);
    const t = _t(e.baseURL, e.url, e.allowAbsoluteUrls);
    return jt(t, e.params, e.paramsSerializer);
  }
};
f.forEach(["delete", "get", "head", "options"], function(e) {
  q.prototype[e] = function(t, s) {
...
let Ls = class zt {
  constructor(e) {
    ...
    this.promise.then((r) => {
      ...
      s.reason || (s.reason = new ee(i, o, a), t(s.reason));
    });
  }
  /**
...
function Jt(n) {
  const e = new q(n), t = Rt(q.prototype.request, e);
  return f.extend(t, q.prototype, e, { allOwnKeys: !0 }), f.extend(t, e, null, { allOwnKeys: !0 }), t.create = function(r) {
    return Jt(z(n, r));
  }, t;
}
const L = Jt(ue);
...
L.mergeConfig = z;
L.AxiosHeaders = F;
L.formToJSON = (n) => Dt(f.isHTMLForm(n) ? new FormData(n) : n);
...
const Ps = (n) => {
  const [e, t] = pe(null), [s, r] = pe(null), [i, o] = pe(!1), { url: a, method: l, data: u, mock: c, auto: p = !0 } = n, h = c ? (d) => en(d.url, d.method, d.data) : (d) => qe(d), y = async () => {
    o(!0);
    try {
      console.log("API request:", a, l, u);
      const d = await h({ url: a, method: l, data: u, ...l === "GET" ? { params: u } : { data: u } });
      console.log("API response: status", d.data ? "ok" : "error"), t(d.data), r(null);
    } catch (d) {
      console.error("API request error:", d), r(d?.message ? d : null), t(null);
    } finally {
      o(!1);
    }
  };
  ...
  const e = `/shaarolami/CustomspilotWeb/SystemTables/api/GetTableData?tableName=${n}`, { response: t, refetch: s } = Ps({ url: e, method: "GET" });
  return {
    response: t,
    refetch: s
  };
}, Mr = ({ fields: n }) => /* @__PURE__ */ T("div", { className: "fields-grid", children: n.map((e, t) => /* @__PURE__ */ Y("div", { className: "field-item", children: [
...
] }, t)) }), As = "link-module__link___W6noI", vs = {
  link: As
}, ks = ({ text: n, onClick: e }) => /* @__PURE__ */ T("h2", { className: vs.link, onClick: e, children: n }), Vr = ({ children: n }) => /* @__PURE__ */ T(
  "button",
  {
    style: {
      padding: "8px 16px",
...
), Fs = "title-module__titleContainer___wZFgq", $s = "title-module__title___wc-C2", js = "title-module__subTitle___uy5--", $e = {
  titleContainer: Fs,
  title: $s,
  subTitle: js
}, Us = ({ title: n, subTitle: e }) => /* @__PURE__ */ Y("div", { className: $e.titleContainer, children: [
  /* @__PURE__ */ T("h1", { className: $e.title, children: n }),
  e !== "" ? /* @__PURE__ */ T("h2", { className: $e.subTitle, children: e }) : null
] }), Ds = "SearchContainer-module__searchContainer___DJ7jd", Is = "SearchContainer-module__searchContent___xBTu-", dt = {
  searchContainer: Ds,
  searchContent: Is
}, Bs = {
  type: "logger",
...
function Ks(n) {
  return typeof n == "string" ? n.replace(/[&<>"'\/]/g, (e) => Vs[e]) : n;
}
const qs = [" ", ",", "?", "!", ";"];
function zs(n, e, t) {
  e = e || "", t = t || "";
...
class gt extends Pe {
  ...
  addResource(e, t, s, r) {
    ...
    let a = [e, t];
    s && (a = a.concat(o ? s.split(o) : s)), e.indexOf(".") > -1 && (a = e.split("."), r = t, t = a[1]), this.addNamespaces(t), pt(this.data, a, r), i.silent || this.emit("added", e, t, s, r);
  }
  addResources(e, t, s) {
    let r = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {
      silent: !1
  ...
  addResourceBundle(e, t, s, r, i) {
    ...
    r ? Wt(l, s, i) : l = {
      ...l,
      ...s
    }, pt(this.data, a, l), o.silent || this.emit("added", e, t, s);
  }
...
class Re extends Pe {
  constructor(e) {
    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    super(), _s(["resourceStore", "languageUtils", "pluralResolver", "interpolator", "backendConnector", "i18nFormat", "utils"], e, this), this.options = t, this.options.keySeparator === void 0 && (this.options.keySeparator = "."), this.logger = I.create("translator");
  }
  changeLanguage(e) {
    e && (this.language = e);
  }
  ...
  translate(e, t, s) {
    ...
    let h = p && p.res;
    const y = p && p.usedKey || o, d = p && p.exactUsedKey || o, m = Object.prototype.toString.apply(h), g = ["[object Number]", "[object Function]", "[object RegExp]"], w = t.joinArrays !== void 0 ? t.joinArrays : this.options.joinArrays, x = !this.i18nFormat || this.i18nFormat.handleAsObject;
    if (x && h && (typeof h != "string" && typeof h != "boolean" && typeof h != "number") && g.indexOf(m) < 0 && !(typeof w == "string" && m === "[object Array]")) {
      if (!t.returnObjects && !this.options.returnObjects) {
        this.options.returnedObjectHandler || this.logger.warn("accessing an object - but returnObjects options is not enabled!");
        const S = this.options.returnedObjectHandler ? this.options.returnedObjectHandler(y, h, {
          ...t,
          ns: a
      ...
      if (i) {
        const S = m === "[object Array]", R = S ? [] : {}, N = S ? d : y;
        for (const O in h)
          if (Object.prototype.hasOwnProperty.call(h, O)) {
            const _ = `${N}${i}${O}`;
            R[O] = this.translate(_, {
              ...t,
              joinArrays: !1,
              ns: a
            }), R[O] === _ && (R[O] = h[O]);
    ...
    } else if (x && typeof w == "string" && m === "[object Array]")
      h = h.join(w), h && (h = this.extendTranslation(h, e, t, s));
    else {
      let S = !1, R = !1;
      const N = t.count !== void 0 && typeof t.count != "string", O = Re.hasDefaultValue(t), _ = N ? this.pluralResolver.getSuffix(u, t.count, t) : "", J = t.ordinal && N ? this.pluralResolver.getSuffix(u, t.count, {
        ordinal: !1
      }) : "", H = t[`defaultValue${_}`] || t[`defaultValue${J}`] || t.defaultValue;
      !this.isValidLookup(h) && O && (S = !0, h = H), this.isValidLookup(h) || (R = !0, h = o);
      const V = (t.missingKeyNoValueFallbackToKey || this.options.missingKeyNoValueFallbackToKey) && R ? void 0 : h, $ = O && H !== h && this.options.updateMissing;
      if (R || S || $) {
        if (this.logger.log($ ? "updateKey" : "missingKey", u, l, o, $ ? H : h), i) {
        ...
        const ne = (C, B, ce) => {
          const j = O && ce !== h ? ce : V;
          this.options.missingKeyHandler ? this.options.missingKeyHandler(C, l, B, j, $, t) : this.backendConnector && this.backendConnector.saveMissing && this.backendConnector.saveMissing(C, l, B, j, $, t), this.emit("missingKey", C, l, B, h);
        };
        this.options.saveMissing && (this.options.saveMissingPlurals && N ? M.forEach((C) => {
          this.pluralResolver.getSuffixes(C, t).forEach((B) => {
            ne([C], o + B, t[`defaultValue${B}`] || H);
          });
        }) : ne(M, o, H));
      }
      h = this.extendTranslation(h, e, t, p, s), R && h === o && this.options.appendNamespaceToMissingKey && (h = `${l}:${o}`), (R || S) && this.options.parseMissingKeyHandler && (this.options.compatibilityAPI !== "v1" ? h = this.options.parseMissingKeyHandler(this.options.appendNamespaceToMissingKey ? `${l}:${o}` : o, S ? h : void 0) : h = this.options.parseMissingKeyHandler(h));
    }
    return r ? (p.res = h, p) : h;
  }
  extendTranslation(e, t, s, r, i) {
    ...
    if (this.i18nFormat && this.i18nFormat.parse)
      ...
      !s.lng && this.options.compatibilityAPI !== "v1" && r && r.res && (s.lng = r.usedLng), s.nest !== !1 && (e = this.interpolator.nest(e, function() {
        for (var h = arguments.length, y = new Array(h), d = 0; d < h; d++)
          y[d] = arguments[d];
  ...
  resolve(e) {
    ...
    return typeof e == "string" && (e = [e]), e.forEach((l) => {
      ...
      const h = t.count !== void 0 && typeof t.count != "string", y = h && !t.ordinal && t.count === 0 && this.pluralResolver.shouldUseIntlApi(), d = t.context !== void 0 && (typeof t.context == "string" || typeof t.context == "number") && t.context !== "", m = t.lngs ? t.lngs : this.languageUtils.toResolveHierarchy(t.lng || this.language, t.fallbackLng);
      p.forEach((g) => {
        this.isValidLookup(s) || (a = g, !mt[`${m[0]}-${g}`] && this.utils && this.utils.hasLoadedNamespace && !this.utils.hasLoadedNamespace(a) && (mt[`${m[0]}-${g}`] = !0, this.logger.warn(`key "${r}" for languages "${m.join(", ")}" won't get resolved as namespace "${a}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), m.forEach((w) => {
          if (this.isValidLookup(s)) return;
          o = w;
          const x = [c];
          if (this.i18nFormat && this.i18nFormat.addLookupKeys)
            this.i18nFormat.addLookupKeys(x, c, w, g, t);
          else {
            let S;
            h && (S = this.pluralResolver.getSuffix(w, t.count, t));
            const R = `${this.options.pluralSeparator}zero`, N = `${this.options.pluralSeparator}ordinal${this.options.pluralSeparator}`;
            if (h && (x.push(c + S), t.ordinal && S.indexOf(N) === 0 && x.push(c + S.replace(N, this.options.pluralSeparator)), y && x.push(c + R)), d) {
              const O = `${c}${this.options.contextSeparator}${t.context}`;
              x.push(O), h && (x.push(O + S), t.ordinal && S.indexOf(N) === 0 && x.push(O + S.replace(N, this.options.pluralSeparator)), y && x.push(O + R));
            }
          }
          let E;
          for (; E = x.pop(); )
            this.isValidLookup(s) || (i = E, s = this.getResource(w, g, E, t));
        }));
      });
    }), {
      res: s,
...
class Qs {
  constructor(e) {
    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    this.languageUtils = e, this.options = t, this.logger = I.create("pluralResolver"), (!this.options.compatibilityJSON || Xs.includes(this.options.compatibilityJSON)) && (typeof Intl > "u" || !Intl.PluralRules) && (this.options.compatibilityJSON = "v3", this.logger.error("Your environment seems not to be Intl API compatible, use an Intl.PluralRules polyfill. Will fallback to the compatibilityJSON v3 format handling.")), this.rules = Ys();
  }
  addRule(e, t) {
    this.rules[e] = t;
  }
  ...
  getSuffixes(e) {
    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    const s = this.getRule(e, t);
    return s ? this.shouldUseIntlApi() ? s.resolvedOptions().pluralCategories.sort((r, i) => bt[r] - bt[i]).map((r) => `${this.options.prepend}${t.ordinal ? `ordinal${this.options.prepend}` : ""}${r}`) : s.numbers.map((r) => this.getSuffix(e, r, t)) : [];
  }
  getSuffix(e, t) {
    let s = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
...
function St(n, e, t) {
  let s = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : ".", r = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : !0, i = Ms(n, e, t);
...
class Zs {
  ...
  init() {
    ...
    this.escape = t.escape !== void 0 ? t.escape : Ks, this.escapeValue = t.escapeValue !== void 0 ? t.escapeValue : !0, this.useRawValueToEscape = t.useRawValueToEscape !== void 0 ? t.useRawValueToEscape : !1, this.prefix = t.prefix ? G(t.prefix) : t.prefixEscaped || "{{", this.suffix = t.suffix ? G(t.suffix) : t.suffixEscaped || "}}", this.formatSeparator = t.formatSeparator ? t.formatSeparator : t.formatSeparator || ",", this.unescapePrefix = t.unescapeSuffix ? "" : t.unescapePrefix || "-", this.unescapeSuffix = this.unescapePrefix ? "" : t.unescapeSuffix || "", this.nestingPrefix = t.nestingPrefix ? G(t.nestingPrefix) : t.nestingPrefixEscaped || G("$t("), this.nestingSuffix = t.nestingSuffix ? G(t.nestingSuffix) : t.nestingSuffixEscaped || G(")"), this.nestingOptionsSeparator = t.nestingOptionsSeparator ? t.nestingOptionsSeparator : t.nestingOptionsSeparator || ",", this.maxReplaces = t.maxReplaces ? t.maxReplaces : 1e3, this.alwaysFormat = t.alwaysFormat !== void 0 ? t.alwaysFormat : !1, this.resetRegExp();
  }
  reset() {
  ...
  interpolate(e, t, s, r) {
    ...
    const c = (d) => {
      if (d.indexOf(this.formatSeparator) < 0) {
        const x = St(t, l, d, this.options.keySeparator, this.options.ignoreJSONStructure);
      ...
      const m = d.split(this.formatSeparator), g = m.shift().trim(), w = m.join(this.formatSeparator).trim();
      return this.format(St(t, l, g, this.options.keySeparator, this.options.ignoreJSONStructure), w, s, {
        ...r,
        ...t,
        interpolationkey: g
      });
    ...
    this.resetRegExp();
    const p = r && r.missingInterpolationHandler || this.options.missingInterpolationHandler, h = r && r.interpolation && r.interpolation.skipOnVariables !== void 0 ? r.interpolation.skipOnVariables : this.options.interpolation.skipOnVariables;
    return [{
      regex: this.regexpUnescape,
      safeValue: (d) => u(d)
    }, {
      regex: this.regexp,
      safeValue: (d) => this.escapeValue ? u(this.escape(d)) : u(d)
    }].forEach((d) => {
      for (a = 0; i = d.regex.exec(e); ) {
        const m = i[1].trim();
        if (o = c(m), o === void 0)
        ...
        else typeof o != "string" && !this.useRawValueToEscape && (o = ht(o));
        const g = d.safeValue(o);
        if (e = e.replace(i[0], g), h ? (d.regex.lastIndex += o.length, d.regex.lastIndex -= i[0].length) : d.regex.lastIndex = 0, a++, a >= this.maxReplaces)
          break;
      }
    }), e;
  }
  nest(e, t) {
    ...
    function a(l, u) {
      ...
      let h = `{${p[1]}`;
      l = p[0], h = this.interpolate(h, o);
      const y = h.match(/'/g), d = h.match(/"/g);
      (y && y.length % 2 === 0 && !d || d.length % 2 !== 0) && (h = h.replace(/'/g, '"'));
      try {
        o = JSON.parse(h), u && (o = {
          ...u,
          ...o
    ...
    for (; r = this.nestingRegexp.exec(e); ) {
      ...
      typeof i != "string" && (i = ht(i)), i || (this.logger.warn(`missed to resolve ${r[1]} for nesting ${e}`), i = ""), u && (i = l.reduce((c, p) => this.format(c, p, s.lng, {
        ...s,
  ...
  format(e, t, s) {
    ...
    return t.split(this.formatSeparator).reduce((a, l) => {
      ...
      if (this.formats[u]) {
        let p = a;
        try {
          const h = r && r.formatParams && r.formatParams[r.interpolationkey] || {}, y = h.locale || h.lng || r.locale || r.lng || s;
...
class sr extends Pe {
  ...
  queueLoad(e, t, s, r) {
    ...
    return e.forEach((u) => {
      ...
      t.forEach((p) => {
        const h = `${u}|${p}`;
        !s.reload && this.store.hasResourceBundle(u, p) ? this.state[h] = 2 : this.state[h] < 0 || (this.state[h] === 1 ? o[h] === void 0 && (o[h] = !0) : (this.state[h] = 1, c = !1, o[h] === void 0 && (o[h] = !0), i[h] === void 0 && (i[h] = !0), l[p] === void 0 && (l[p] = !0)));
      }), c || (a[u] = !0);
  ...
  loaded(e, t, s) {
    ...
    this.queue.forEach((l) => {
      Hs(l.loaded, [i], o), nr(l, e), t && l.errors.push(t), l.pendingCount === 0 && !l.done && (Object.keys(l.loaded).forEach((u) => {
        a[u] || (a[u] = {});
        const c = l.loaded[u];
...
class ie extends Pe {
  constructor() {
    ...
    if (super(), this.options = xt(e), this.services = {}, this.logger = I, this.modules = {
      external: []
    }, rr(this), t && !this.isInitialized && !e.isClone) {
  ...
  init() {
    ...
    if (!this.options.isClone) {
      ...
      let c;
      this.modules.formatter ? c = this.modules.formatter : typeof Intl < "u" && (c = tr);
      const p = new yt(this.options);
      this.store = new gt(this.options.resources, this.options);
      const h = this.services;
      h.logger = I, h.resourceStore = this.store, h.languageUtils = p, h.pluralResolver = new Qs(p, {
        prepend: this.options.pluralSeparator,
        compatibilityJSON: this.options.compatibilityJSON,
        simplifyPluralSuffix: this.options.simplifyPluralSuffix
      }), c && (!this.options.interpolation.format || this.options.interpolation.format === r.interpolation.format) && (h.formatter = i(c), h.formatter.init(h, this.options), this.options.interpolation.format = h.formatter.format.bind(h.formatter)), h.interpolator = new Zs(this.options), h.utils = {
        hasLoadedNamespace: this.hasLoadedNamespace.bind(this)
      }, h.backendConnector = new sr(i(this.modules.backend), h.resourceStore, h, this.options), h.backendConnector.on("*", function(y) {
    ...
    const l = re(), u = () => {
      const c = (p, h) => {
        this.isInitialized && !this.initializedStoreOnce && this.logger.warn("init: i18next is already initialized. You should call init just once!"), this.isInitialized = !0, this.options.isClone || this.logger.log("initialized", this.options), this.emit("initialized", this.options), l.resolve(h), s(p, h);
      };
  ...
  getFixedT(e, t, s) {
    ...
    const i = function(o, a) {
      ...
      const h = r.options.keySeparator || ".";
      let y;
      return l.keyPrefix && Array.isArray(o) ? y = o.map((d) => `${l.keyPrefix}${h}${d}`) : y = l.keyPrefix ? `${l.keyPrefix}${h}${o}` : o, r.t(y, l);
    };
  ...
  dir(e) {
    ...
    const t = ["ar", "shu", "sqr", "ssh", "xaa", "yhd", "yud", "aao", "abh", "abv", "acm", "acq", "acw", "acx", "acy", "adf", "ads", "aeb", "aec", "afb", "ajp", "apc", "apd", "arb", "arq", "ars", "ary", "arz", "auz", "avl", "ayh", "ayl", "ayn", "ayp", "bbz", "pga", "he", "iw", "ps", "pbt", "pbu", "pst", "prp", "prd", "ug", "ur", "ydd", "yds", "yih", "ji", "yi", "hbo", "men", "xmn", "fa", "jpr", "peo", "pes", "prs", "dv", "sam", "ckb"], s = this.services && this.services.languageUtils || new yt(wt());
  ...
  cloneInstance() {
    ...
    }, s && (i.store = new gt(this.store.data, r), i.services.resourceStore = i.store), i.translator = new Re(i.services, r), i.translator.on("*", function(a) {
...
P.createInstance = ie.createInstance;
P.createInstance;
P.dir;
P.init;
P.loadResources;
...
P.loadNamespaces;
P.loadLanguages;
const ir = "Search", or = "Clear", ar = {
  Search: ir,
  Clear: or
}, lr = "חיפוש", ur = "נקה", cr = "הסבר לשאילתה", fr = {
  Search: lr,
  Clear: ur,
  queryExplanation: cr
};
...
P.languages = ["en", "he"];
const Xt = () => Zt(), dr = "SearchButtonsContainer-module__searchButtonsContainer___x8BG-", hr = {
  ...
  return /* @__PURE__ */ Y("div", { className: hr.searchButtonsContainer, children: [
    e && /* @__PURE__ */ T(
      We,
      {
        label: "Search",
        icon: /* @__PURE__ */ T(Ge, { name: "search" }),
        onClick: i,
        disabled: s,
        children: a("Search")
      }
  ...
  return /* @__PURE__ */ Y("div", { className: dt.searchContainer, children: [
    /* @__PURE__ */ T("div", { className: dt.searchContent, children: n.children }),
    e && /* @__PURE__ */ T(pr, { ...e })
  ] });
}, mr = "MainSearchContainer-module__mainSearchContainer___99z-w", yr = "MainSearchContainer-module__mainSearchInfoLink___BBPWA", br = "MainSearchContainer-module__mainSearchToast___t-0dD", Ue = {
  mainSearchContainer: mr,
  mainSearchInfoLink: yr,
  mainSearchToast: br
}, Kr = (n) => {
  const { infoText: e, pageTitle: t, buttonsProps: s } = n, [r, i] = pe(!1), { t: o } = Xt();
  return /* @__PURE__ */ Y("div", { className: Ue.mainSearchContainer, children: [
    /* @__PURE__ */ T(Us, { title: t, subTitle: "" }),
    e && /* @__PURE__ */ Y("div", { className: Ue.mainSearchInfoLink, children: [
      /* @__PURE__ */ T(ks, { onClick: () => i(!r), text: o("queryExplanation") }),
      r && /* @__PURE__ */ T(Yt, { className: Ue.mainSearchToast, children: e })
    ] }),
    n.children && /* @__PURE__ */ T(gr, { buttonsProps: s, children: n.children })
  ] });
}, qr = (n) => (Ot(() => {
...
}, ["test"]), /* @__PURE__ */ T("div", { className: "rootLayout", style: { direction: "rtl" }, children: n.children }));
export {
  Vr as Button,
  Mr as FieldsGrid,
  ks as Link,
  Kr as MainSearchContainer,
  qr as RootLayout,
  Us as Title,
  P as i18n,
  en as mockApiRequest,
  Ps as useApiRequest,
  Hr as useSystemTableApiRequest,
