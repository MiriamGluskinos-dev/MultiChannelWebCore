...
const { toString: _t } = Object.prototype, { getPrototypeOf: Te } = Object, { iterator: ie, toStringTag: et } = Symbol, ae = /* @__PURE__ */ ((e) => (t) => {
  const n = _t.call(t);
  return e[n] || (e[n] = n.slice(8, -1).toLowerCase());
})(/* @__PURE__ */ Object.create(null)), P = (e) => (e = e.toLowerCase(), (t) => ae(t) === e), ce = (e) => (t) => typeof t === e, { isArray: z } = Array, $ = ce("undefined");
function W(e) {
...
const Nt = ce("string"), C = ce("function"), nt = ce("number"), K = (e) => e !== null && typeof e == "object", Pt = (e) => e === !0 || e === !1, ne = (e) => {
  if (ae(e) !== "object")
    return !1;
  const t = Te(e);
...
}, kt = P("Date"), Lt = P("File"), Bt = P("Blob"), Ut = P("FileList"), Dt = (e) => K(e) && C(e.pipe), jt = (e) => {
  let t;
  return e && (typeof FormData == "function" && e instanceof FormData || C(e.append) && ((t = ae(e)) === "formdata" || // detect form-data instance
  t === "object" && C(e.toString) && e.toString() === "[object FormData]"));
}, qt = P("URLSearchParams"), [It, Ht, Mt, $t] = ["ReadableStream", "Request", "Response", "Headers"].map(P), zt = (e) => e.trim ? e.trim() : e.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
...
const j = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : global, st = (e) => !$(e) && e !== j;
function we() {
  const { caseless: e, skipUndefined: t } = st(this) && this || {}, n = {}, r = (s, i) => {
    const o = e && rt(n, i) || i;
    ne(n[o]) && ne(s) ? n[o] = we(n[o], s) : ne(s) ? n[o] = we({}, s) : z(s) ? n[o] = s.slice() : (!t || !$(s)) && (n[o] = s);
  };
...
const vt = (e, t, n, { allOwnKeys: r } = {}) => (X(t, (s, i) => {
  ...
  for (; t-- > 0; )
    n[t] = e[t];
  return n;
}, Gt = /* @__PURE__ */ ((e) => (t) => e && t instanceof e)(typeof Uint8Array < "u" && Te(Uint8Array)), Qt = (e, t) => {
...
), Be = (({ hasOwnProperty: e }) => (t, n) => e.call(t, n))(Object.prototype), tn = P("RegExp"), ot = (e, t) => {
...
function an(e) {
  return !!(e && C(e.append) && e[et] === "FormData" && e[ie]);
}
const cn = (e) => {
  ...
  return n(e, 0);
}, ln = P("AsyncFunction"), un = (e) => e && (K(e) || C(e)) && C(e.then) && C(e.catch), it = ((e, t) => e ? setImmediate : t ? ((n, r) => (j.addEventListener("message", ({ source: s, data: i }) => {
  ...
  C(j.postMessage)
), fn = typeof queueMicrotask < "u" ? queueMicrotask.bind(j) : typeof process < "u" && process.nextTick || it, dn = (e) => e != null && C(e[ie]), a = {
  isArray: z,
  isArrayBuffer: tt,
  isBuffer: W,
  isFormData: jt,
  ...
  function u(l, m, h) {
    ...
    if (l && !h && typeof l == "object") {
      if (a.endsWith(m, "{}"))
        ...
        return m = lt(m), E.forEach(function(g, O) {
    ...
    return Se(l) ? !0 : (t.append(Ue(h, m, i), f(l)), !1);
  }
...
}, bn = typeof URLSearchParams < "u" ? URLSearchParams : Oe, wn = typeof FormData < "u" ? FormData : null, Sn = typeof Blob < "u" ? Blob : null, En = {
  isBrowser: !0,
  classes: {
    URLSearchParams: bn,
    FormData: wn,
...
}, Ce = typeof window < "u" && typeof document < "u", Ee = typeof navigator == "object" && navigator || void 0, gn = Ce && (!Ee || ["ReactNative", "NativeScript", "NS"].indexOf(Ee.product) < 0), Rn = typeof WorkerGlobalScope < "u" && // eslint-disable-next-line no-undef
...
}, He = (e) => (...t) => a.asap(() => e(...t)), qn = T.hasStandardBrowserEnv ? /* @__PURE__ */ ((e, t) => (n) => (n = new URL(n, T.origin), e.protocol === n.protocol && e.host === n.host && (t || e.port === n.port)))(
  new URL(T.origin),
...
const bt = (e) => {
  ...
  if (t.headers = o = A.from(o), t.url = ft(yt(t.baseURL, t.url, t.allowAbsoluteUrls), e.params, e.paramsSerializer), c && o.set(
    "Authorization",
  ...
  return new Promise(function(n, r) {
    ...
    "onloadend" in h ? h.onloadend = E : h.onreadystatechange = function() {
      ...
      const N = O && O.message ? O.message : "Network Error", U = new y(N, y.ERR_NETWORK, e, h);
      U.event = O || null, r(U), h = null;
...
}, ze = 64 * 1024, { isFunction: ee } = a, wt = (({ fetch: e, Request: t, Response: n }) => ({
  fetch: e,
  Request: t,
  Response: n
}))(a.global), {
  ...
  const { fetch: t, Request: n, Response: r } = Object.assign({}, wt, e), s = ee(t), i = ee(n), o = ee(r);
  if (!s)
    return !1;
  const c = s && ee(ve), d = s && (typeof Je == "function" ? /* @__PURE__ */ ((l) => (m) => l.encode(m))(new Je()) : async (l) => new Uint8Array(await new n(l).arrayBuffer())), f = i && c && Ve(() => {
    let l = !1;
    ...
    return l && !m;
  }), u = o && c && Ve(() => a.isReadableStream(new r("").body)), p = {
    stream: u && ((l) => l.body)
  };
  ...
  return async (l) => {
    ...
    let Z = vn([_, g && g.toAbortSignal()], O), J = null;
    const D = Z && Z.unsubscribe && (() => {
      Z.unsubscribe();
    });
    let xe;
    try {
      if (U && f && h !== "get" && h !== "head" && (xe = await S(fe, E)) !== 0) {
        let B = new n(m, {
          method: "POST",
          body: E,
          duplex: "half"
        }), H;
        if (a.isFormData(E) && (H = B.headers.get("content-type")) && fe.setContentType(H), B.body) {
          const [de, Y] = Ie(
            xe,
            oe(He(U))
          );
      ...
      J = i && new n(m, Ne);
      let L = await (i ? t(J, _e) : t(m, Ne));
      const Pe = u && (x === "stream" || x === "response");
      if (u && (N || Pe && D)) {
        const B = {};
      ...
      x = x || "text";
      let Ot = await p[a.findKey(p, x) || "text"](L, l);
      return !Pe && D && D(), await new Promise((B, H) => {
        mt(B, H, {
          data: Ot,
  ...
  let o = i.length, c = o, d, f, u = Xn;
  for (; c--; )
    d = i[c], f = u.get(d), f === void 0 && u.set(d, f = c ? /* @__PURE__ */ new Map() : Kn(t)), u = f;
  return f;
};
St();
const ge = {
...
const We = (e) => `- ${e}`, Gn = (e) => a.isFunction(e) || e === null || e === !1, Et = {
  getAdapter: (e, t) => {
    e = a.isArray(e) ? e : [e];
    const { length: n } = e;
    let r, s;
    ...
    for (let o = 0; o < n; o++) {
      r = e[o];
      let c;
      if (s = r, !Gn(r) && (s = ge[(c = String(r)).toLowerCase()], s === void 0))
...
function Ke(e) {
  return me(e), e.headers = A.from(e.headers), e.data = pe.call(
    ...
    return pt(r) || (me(e), r && r.response && (r.response.data = pe.call(
      e,
      e.transformResponse,
      r.response
...
w.mergeConfig = I;
w.AxiosHeaders = A;
w.formToJSON = (e) => ht(a.isHTMLForm(e) ? new FormData(e) : e);
...
const tr = (e) => {
  ...
  const t = `/shaarolami/CustomspilotWeb/SystemTables/api/GetTableData?tableName=${e}`, { response: n, refetch: r } = tr({ url: t, method: "GET" });
  return {
    response: n,
    refetch: r
  };
}, Mr = ({ fields: e }) => /* @__PURE__ */ R("div", { className: "fields-grid", children: e.map((t, n) => /* @__PURE__ */ M("div", { className: "field-item", children: [
...
] }, n)) }), nr = "link-module__link___jpeXq", rr = {
  link: nr
}, sr = ({ text: e, onClick: t }) => /* @__PURE__ */ R("h2", { className: rr.link, onClick: t, children: e }), $r = ({ children: e }) => /* @__PURE__ */ R(
  "button",
  {
    style: {
      padding: "8px 16px",
...
), or = "title-module__titleContainer___cg-XE", ir = "title-module__title___8bzQ8", ar = "title-module__subTitle___abvaA", ye = {
  titleContainer: or,
  title: ir,
  subTitle: ar
}, cr = ({ title: e, subTitle: t }) => /* @__PURE__ */ M("div", { className: ye.titleContainer, children: [
  /* @__PURE__ */ R("h1", { className: ye.title, children: e }),
  t !== "" ? /* @__PURE__ */ R("h2", { className: ye.subTitle, children: t }) : null
] }), lr = "SearchContainer-module__searchContainer___UiSUG", ur = "SearchContainer-module__searchContent___g1iR3", Ge = {
  searchContainer: lr,
  searchContent: ur
}, fr = "SearchButtonsContainer-module__searchButtonsContainer___sSZIE", dr = {
  ...
  return /* @__PURE__ */ M("div", { className: dr.searchButtonsContainer, children: [
    t && /* @__PURE__ */ R(
      ke,
      {
        label: "Search",
  ...
  return /* @__PURE__ */ M("div", { className: Ge.searchContainer, children: [
    /* @__PURE__ */ R("div", { className: Ge.searchContent, children: e.children }),
    t && /* @__PURE__ */ R(hr, { ...t })
  ] });
}, mr = "MainSearchContainer-module__mainSearchContainer___oR1-B", yr = "MainSearchContainer-module__mainSearchInfoLink___tmN-g", br = "MainSearchContainer-module__mainSearchToast___Kth2t", be = {
  mainSearchContainer: mr,
  mainSearchInfoLink: yr,
  mainSearchToast: br
}, zr = (e) => {
  const { infoText: t, pageTitle: n, buttonsProps: r } = e, [s, i] = te(!1), { t: o } = Ze();
  return /* @__PURE__ */ M("div", { className: be.mainSearchContainer, children: [
    /* @__PURE__ */ R(cr, { title: n, subTitle: "" }),
    t && /* @__PURE__ */ M("div", { className: be.mainSearchInfoLink, children: [
      /* @__PURE__ */ R(sr, { onClick: () => i(!s), text: o("queryExplanation") }),
      s && /* @__PURE__ */ R(Ct, { className: be.mainSearchToast, children: t })
    ] }),
    e.children && /* @__PURE__ */ R(pr, { buttonsProps: r, children: e.children })
  ] });
}, vr = (e) => (Qe(() => {
